package com.openinnovations.fileprocessing.services;
import java.util.Properties;

import com.openinnovations.fileprocessing.model.SentimentClassification;
...
public class SentimentAnalyzerService {
    ...
    public SentimentResult getSentimentResult(String text) {
        ...
        System.out.println("Sentimientos analizados");
